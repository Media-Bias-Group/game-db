...
class CreateTutorialWordsAnswersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tutorial_words_answers', function (Blueprint $table) {
              $table->increments('id');
    ...
    {
        Schema::dropIfExists('tutorial_words_answers');
    }
}
