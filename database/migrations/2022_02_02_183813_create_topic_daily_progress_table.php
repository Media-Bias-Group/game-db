...
class CreateTopicDailyProgressTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('topic_daily_progress', function (Blueprint $table) {
             $table->increments('id');
    ...
    {
        Schema::dropIfExists('topic_daily_progress');
    }
}
